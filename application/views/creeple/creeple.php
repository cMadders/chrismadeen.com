...
<body>
	...
	<script type="text/javascript" src="http://www.chrismadeen.com/scripts/creeple_test.js"></script>
	<script type="text/javascript">//<![CDATA[
		...
		(function() {
			...
			engine.startGame('http://www.chrismadeen.com/scripts/' + BASENAME + '.pck').then(() => {
